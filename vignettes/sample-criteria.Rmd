...
@Pate2023-yh[p.563] recommends derive $R^2_{CS,adj,k,r}$ by the approach suggested by @Rileym441. (Referred as $\varphi_{k,r}$ approach in figure \ref{fig1})
